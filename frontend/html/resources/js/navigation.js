...
<div class="container">
    <div class="d-flex flex-wrap justify-content-around justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0" id="functions">
...
navigation += `
        <div class="dropdown text-end">
            <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1"
                data-bs-toggle="dropdown" aria-expanded="false" style="color: rgb(255, 255, 255);">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" style="color: rgb(255, 255, 255);" class="bi bi-person-circle" viewBox="0 0 16 16">
...
if (isDoctor === 'false') navigation += `<li><a class="dropdown-item" href="http://0.0.0.0:3001/profile">Мои вопросы</a></li>`;
else navigation += `<li><a class="dropdown-item" href="http://0.0.0.0:3001/profile">Мои статьи</a></li>
                    <li><a class="dropdown-item" href="http://0.0.0.0:3001/profile">Мои ответы</a></li>`;
navigation += `<li>
